"""
Django settings for explonary project.
...
SECRET_KEY = 'gglni&&vs(r8$68-9@!t7c3$^)may@l3e7jsc^9)&ehnv*y$ns'
...
WSGI_APPLICATION = 'explonary.wsgi.application'
